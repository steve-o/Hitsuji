...
#ifndef CHROMIUM_FILES_IMPORTANT_FILE_WRITER_HH_
#define CHROMIUM_FILES_IMPORTANT_FILE_WRITER_HH_
...
class ImportantFileWriter : public NonThreadSafe, boost::noncopyable {
 public:
  ...
  ImportantFileWriter(const FilePath& path,
                      chromium::SequencedTaskRunner* task_runner);
 ...
 private:
  ...
  const scoped_refptr<chromium::SequencedTaskRunner> task_runner_;
...
#endif  // CHROMIUM_FILES_IMPORTANT_FILE_WRITER_HH_

...
#ifndef CHROMIUM_MEMORY_MRU_CACHE_HH_
#define CHROMIUM_MEMORY_MRU_CACHE_HH_
...
class MRUCacheBase : boost::noncopyable {
 public:
 ...
 public:
  ...
  MRUCacheBase(size_type max_size, const DeletorType& deletor) : max_size_(max_size), deletor_(deletor) {}
...
struct MRUCacheHashMap {
  typedef boost::unordered_map<KeyType, ValueType> Type;
};
...
#endif  // CHROMIUM_MEMORY_MRU_CACHE_HH_

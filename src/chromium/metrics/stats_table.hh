...
#ifndef CHROMIUM_METRICS_STATS_TABLE_HH_
#define CHROMIUM_METRICS_STATS_TABLE_HH_
#pragma once
...
class StatsTable : boost::noncopyable {
 public:
  ...
  int GetRowValue(int index, int32_t pid) const;
  ...
  int GetCounterValue(const std::string& name, int32_t pid);

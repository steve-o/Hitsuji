 ...
 */
void
hitsuji::provider_t::OnConnection (
...
void
hitsuji::provider_t::RejectConnection (
	RsslServer* rssl_sock
	)
{
#ifndef NDEBUG
...
void
hitsuji::provider_t::AcceptConnection (
	RsslServer* rssl_sock
	)
{
#ifndef NDEBUG
...
void
hitsuji::provider_t::OnCanReadWithoutBlocking (
	RsslChannel* c
	)
{
	DCHECK (nullptr != c);
...
void
hitsuji::provider_t::OnInitializingState (
	RsslChannel* c
	)
{
...
void
hitsuji::provider_t::OnCanWriteWithoutBlocking (
	RsslChannel* c
	)
{
	RsslError rssl_err;
 ...
 */
void
hitsuji::provider_t::OnActiveClientSession (
	RsslChannel* c
	)
{
	DCHECK (nullptr != c);
...
void
hitsuji::provider_t::OnActiveState (
	RsslChannel* c
	)
{
	RsslBuffer* buf;
...
bool
hitsuji::provider_t::AcceptClientSession (
	RsslChannel* handle,
	const char* address
	)
{
...
bool
hitsuji::provider_t::GetServiceFilterList (
	RsslEncodeIterator*const it,
	uint32_t filter_mask
	)
{
 ...
 */
bool
hitsuji::provider_t::GetServiceInformation (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
 ...
 */
bool
hitsuji::provider_t::GetServiceCapabilities (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
...
bool
hitsuji::provider_t::GetServiceDictionaries (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
...
bool
hitsuji::provider_t::GetServiceQoS (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
 ...
 */
bool
hitsuji::provider_t::GetServiceState (
	RsslEncodeIterator*const it
	)
{
#ifndef NDEBUG
